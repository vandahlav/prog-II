...
ColumnLayout {
	...
	RowLayout {
		...
		// nemusím mu říkat, aby následující dva buttons byly zarovnány doprava. Tenhle roztahovací rectangle je tam automaticky posune
		Rectangle {
			id: inputRect
			...
			border.width: 1
			border.color: "black"
			radius: 5 //zaoblené rohy na 5 pixelů

			TextInput {
				id: newTaskInput
				focus: true					// Take focus on start
				width: parent.width - 2				// Decrease the size because of the border (aka border.width); rectangle je tady ten parent
				height: parent.height - 2
				// jinak verticalAlignment zaokrouhluje nahoru? podívat se na dokumentaci
